...
chatly = int(input('Сколько чатлов? '))
CR = float(chatly / 2200)
chips = 0.5

print(f'Это {CR} CR', f'Можно купить кораблей: {int(CR / chips)}', sep='\n')
...
if x_Squre < 0 or y_Squre < 0:
    print('Клетки с такой координатой не существует')
else:
    print(f'Фигура находится в клетке: {x_Squre, y_Squre}')
...
x_center = (x_Squre / 10 + center) - x
y_center = (y_Squre / 10 + center) - y
