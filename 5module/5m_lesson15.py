...
Решите задание двумя способами: первый — при выполнении условия выводится сообщение:
«Можно получить посылку», второй —  при выполнении условия выводится сообщение: «Посылку получить нельзя». """

time = int(input('Введите время:  '))

if time >= 8 and time != 10 and time != 14 and time != 15 and time != 18 and time <= 22:
    print('Можно получить посылку')
else:
    print('Посылку получить нельзя!')

print('--------------------------------------------------------------------------------')
if time < 8 or time == 10 or time == 14 or time == 15 or time == 18 or time > 22:
    print('Посылку получить нельзя!')
else:
    print('Можно получить посылку')
